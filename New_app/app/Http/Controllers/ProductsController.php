...
class ProductsController extends Controller
{
    ...
    public function createVendor()
    {
        $menu_active=3;
        $categories=Category_model::where('parent_id',0)->pluck('name','id')->all();
        return view('vendors.products.create',compact('menu_active','categories'));
    }
    ...
    public function myproducts()
    {
        ...
        return view('backEnd.products.index',compact('menu_active','myproducts','i'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('backEnd.products.index')->with('message','Add Products Successfully!');
    }
    ...
    {  
        ...
        $update_product->update($formInput);  //dd('test'); exit();
        
        if (session()->has('vendorUser')){
            return redirect()->route('backEnd.products.index')->with('message','Update Products Successfully!');  
        }
        else{
    ...
    { 
        ...
        if (session()->has('vendorUser')){
            return redirect()->route('backEnd.products.index')->with('message','Delete Success!');  
        }
