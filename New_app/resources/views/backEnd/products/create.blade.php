...
@section('content')
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="">Products</a> <a href="" class="current">Add New Product</a> </div>
    <div class="container-fluid">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form action="{{url('/product_store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
